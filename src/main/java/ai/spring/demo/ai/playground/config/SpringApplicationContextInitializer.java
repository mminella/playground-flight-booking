...
public class SpringApplicationContextInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
	...
	private void addCloudProfile(ConfigurableEnvironment appEnvironment) {
		...
		if (!llmServices.isEmpty()) {
			...
			String apiBase = (String) llmCredentials.getMap().get("api_base");
			apiBase = apiBase.replace("/v1", "");
			System.out.println(">>>>>>> SAVING API BASE AS : " + apiBase);
			appEnvironment.getSystemProperties().put("spring.ai.openai.base-url", apiBase + "/");
		...
		System.out.println("**********************************************************************");
		System.out.println(">>> url = " + appEnvironment.getSystemProperties().get("spring.ai.openai.base-url"));
		System.out.println(">>> apiKey = " + appEnvironment.getSystemProperties().get("spring.ai.openai.api-key"));
		System.out.println("**********************************************************************");
	}
